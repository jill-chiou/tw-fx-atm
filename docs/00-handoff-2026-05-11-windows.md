...
** 我自己想的: **
如果可以從官網上撈到最新的資料，會不會反而用官網撈比較準?
這樣是不是也比較可以用到資料庫概念，然後可以多一點技術棧可以說明，更完善? 
只是問題就是要怎麼更新geocode，因為目前有使用TGOS，但這個必須要上傳csv到網路，除非用 Nominatim ，只是準確率可能沒有TGOS高，有limit，不能在時間內打太多次，記得sleep